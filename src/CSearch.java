...
public class CSearch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer_Name", "year", "month", "previous reading", "current reading", "consumed units", "amount"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel2.setText("Enter constomer name");
    ...
    Customers c=new Customers(jTextField1.getText());
